...
public:
    ...
    void Update(b2ContactListener listener)
    {
        ...
        if (wasTouching == false && touching == true && listener.BeginContact !is null)
        {
            listener.BeginContact(this);
        }

        if (wasTouching == true && touching == false && listener.EndContact !is null)
        {
            listener.EndContact(this);
        }

        if (sensor == false && touching && listener.PreSolve !is null)
        {
