...
struct b2ContactListener
{
    ...
    void delegate(b2Contact) BeginContact;

	/// Called when two fixtures cease to touch.
	void delegate(b2Contact) EndContact;
    ...
    /// the next step.
	void delegate(b2Contact, const(b2Manifold)*) PreSolve;
	...
	void delegate(b2Contact, const(b2ContactImpulse)*) PostSolve;

}

/// Callback class for AABB queries.
/// See b2World*.Query
alias b2QueryCallback = bool delegate(b2Fixture* fixture);
